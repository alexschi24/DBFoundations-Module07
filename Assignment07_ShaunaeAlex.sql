...
-- 2024-02-28,ShaunaeAlex,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_ShaunaeAlex')
	 Begin 
	  Alter Database [Assignment07DB_ShaunaeAlex] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_ShaunaeAlex;
	 End
	Create Database Assignment07DB_ShaunaeAlex;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_ShaunaeAlex;
